...
import {getPtrDetailsById as getPtrDetailsByIdAdmin} from "app/main/PTR/Admin/API";
                                ...
                                <table cellPadding={2} cellSpacing={2} border={0}>
                                    ...
                                    <tr>
                                        <td className={classes.label}>Requested
                                            Date: <span> {currentPTRDetail.request_date ? moment(currentPTRDetail.request_date).format('DD/MM/YYYY') : '-'}</span>
                                        </td>
                                        <td className={classes.label}>Dated: <span>{currentPTRDetail?.summary?.dated ? moment(currentPTRDetail.summary?.dated).format('DD/MM/YYYY') : '-'}</span>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                                ...
                                <table cellPadding={4} cellSpacing={4} border={0}>
                                    ...
                                    <tr>
                                        <td className={classes.label}>Recorded
                                            Date: <span>{currentPTRDetail.summary?.recorded ? moment(currentPTRDetail.summary?.recorded).format('DD/MM/YYYY') : '-'}</span>
                                        </td>
                                        <td className={classes.label}>Updated
                                            Date: <span>{currentPTRDetail.summary?.updated_at ? moment(currentPTRDetail.summary?.updated_at).format('DD/MM/YYYY') : '-'}</span>
                                        </td>
                                    </tr>
                                    <tr>
            ...
            <Grid container spacing={2} className={classes.headerWrapper}>
                <Grid item xs={3} className="p-36">
                    <div className={classes.logoWrapper}>
                        <img src="assets/images/logos/PinPointV2-bg.png" alt="PINPOINTGUAM"/>
                    </div>
                </Grid>
