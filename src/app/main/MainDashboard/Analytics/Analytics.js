...
import LocationStatusCount from "./LocationStatusCount";

import AplineAreaChart from "./splineAreaChart";

import { fetchChartData73 } from "../../store/chartSlice";
...
const Analytics = () => {
  ...
  const surveyQuestion = useSelector(({ survey }) => survey.questions);
